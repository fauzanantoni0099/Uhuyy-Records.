                ...
                <table class="table table-striped">
                    ...
                    @forelse($testimonis as $testimoni)
                        <tr>
                            ...
                            <td>{{$testimoni->job}}</td>
                            <td>{{$testimoni->note}}</td>
                            <td>@forelse($testimoni->images as $image)
                            ...
                            <td>
                                <div class="form-group">
                                    <a href="" class="btn btn-outline-warning" data-toggle="modal" data-target="#exampleModal-{{$testimoni->id}}"
                                       id="#myBtn" ><i class="feather icon-edit-2"></i></a>
{{--                                    <a href="" class="btn btn-outline-secondary" data-toggle="modal" data-target="#showModal-{{$testimoni->id}}"--}}
